...
class CryptoCompareService {
  ...
  public async steemPrice(currency: string): Promise<number | undefined> {
    const response = await this.get(`https://min-api.cryptocompare.com/data/price?fsym=STEEM&tsyms=${currency}`);
  ...
  public async sbdPrice(currency: string): Promise<number | undefined> {
    const response = await this.get(`https://min-api.cryptocompare.com/data/price?fsym=SBD&tsyms=${currency}`);
